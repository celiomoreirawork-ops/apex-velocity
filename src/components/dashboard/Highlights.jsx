...
export default function Highlights({ biggestSale, biggestSaleVal, biggestSaleQty, leaderVolume, leaderVolumeCount, topModel, topModelCount, avgTicket }) {
  const props = { biggestSale, biggestSaleVal, biggestSaleQty, leaderVolume, leaderVolumeCount, topModel, topModelCount, avgTicket };

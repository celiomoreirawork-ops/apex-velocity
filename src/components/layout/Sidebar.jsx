  ...
  return (
    <aside style={{ width: '100%', height: '100%' }}>
      <div style={{ position: 'relative', height: '100%' }}>
        <div style={{ height: '100%', overflowY: 'auto', paddingTop: 24, paddingBottom: 120 }}>
          {/* Logo Container */}
          <div style={{ marginBottom: 48, display: 'flex', justifyContent: 'center' }}>
            ...
            >
              ...
              <path d="M52.231 19.3315H49.1714L47.814 16.356H40.6851L39.3374 19.3315H36.2983L42.7134 5.67822H45.7524L52.231 19.3315ZM41.7456 14.0142H46.7456L44.2358 8.51416L41.7456 14.0142Z" fill="#FFFFFF" />
              ...
              <path d="M88.7251 8.02002H78.2153V11.4185H86.8257V13.6343H78.2153V16.9897H88.7456V19.3315H75.4087V5.67822H88.7251V8.02002Z" fill="#FFFFFF" />
              <path d="M100.587 10.4585L104.48 5.67822H107.899L102.15 12.3843L107.961 19.3315H104.395L100.533 14.3315L96.5659 19.3315H93.147L98.9663 12.4038L93.3579 5.67822H96.7769L100.587 10.4585Z" fill="#FFFFFF" />

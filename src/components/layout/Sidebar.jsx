...
const Logo = () => (
  <svg width="120" height="auto" viewBox="0 0 192 26" fill="none" stroke="none" strokeWidth="0" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', margin: '0 auto' }}>
...
export default function Sidebar({ activePage, onPageChange, status }) {
  return (
    <aside style={{
      ...
      zIndex: 40,
      borderRight: `2px solid ${C.gray600}`, // Visual separator between menu and content
    }}>
      {/* Logo Container */}

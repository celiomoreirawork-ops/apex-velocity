...
const C = {
  ...
  blue400:  '#5B9FFF',
  blue700:  '#0523E5',
  blueBrand: '#4785FF', // Brand Blue for Hover
  white:    '#FFFFFF',
};

const Logo = () => (
    <svg width="120" viewBox="0 0 192 26" fill="none" stroke="none" strokeWidth="0" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }}>
...
const NavButton = ({ id, label, Icon, isActive, onClick }) => {
    ...
    return (
        <div 
            ...
            style={{ position: 'relative', borderRadius: 9999, overflow: 'hidden', padding: 1.5 }}
        >
            ...
            <div 
                ...
                style={{ 
                    ...
                    width: '200%',
                    height: '200%',
                    background: 'conic-gradient(from 0deg, #4785FF, #0523E5, #94D1FF, #4785FF)',
                    opacity: 0,
                    zIndex: 0
                }}
            />
            ...
            <button
                ...
                style={{
                    ...
                    padding: '10px 16px',
                    borderRadius: 9999,
                    background: isActive ? 'rgba(91,159,255,0.15)' : C.gray900, // Match sidebar bg when not active
  ...
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, paddingLeft: 12 }}>
        ...
        <span style={{ fontSize: 10, fontWeight: 400, color: C.gray600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
